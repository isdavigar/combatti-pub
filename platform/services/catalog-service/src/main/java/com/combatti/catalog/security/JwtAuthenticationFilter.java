package com.combatti.catalog.security;
...
/**
 * Valida el JWT entrante y autentica la petición. El catalog-service valida
 * el token por sí mismo (zero-trust) aunque el gateway ya lo haya validado.
 */
